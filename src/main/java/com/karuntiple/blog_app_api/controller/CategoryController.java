...
import com.karuntiple.blog_app_api.service.CategoryService;
...
//	delete
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Long catId) {
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(AppConstants.CATEGORY_DELETED, true), HttpStatus.OK);
